...
def simple_sample_data(source_path, target_path, sample_frac=0.1):
    """
...
df_sample = simple_sample_data('C:\\projects\\MLOPS-fullstack\\ref_folder\\data.csv', 'C:\\projects\\MLOPS-fullstack\\locals3\\sampled.csv', 0.01)